...
public class Test2 extends MainTest {
    ...
    Test2() {
        ...
        ID_var_a = R.array.test2_variant_a;
        ID_var_b = R.array.test2_variant_b;
        ID_var_c = R.array.test2_variant_c;
        ID_question = R.array.test2_questions_array;
        super.a = var_a;
        super.b = var_b;
        super.c = var_c;
    }
    ...
    void result(TextView TVresult, int result) {
        if (result > 70)
            ...
            TVresult.setText(R.string.test2_35_75);
        }
    }
}
